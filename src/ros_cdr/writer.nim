...
proc write*(this: CdrWriter, val: CdrBasicTypes): CdrWriter {.discardable.} =
...
proc writeBe*(this: CdrWriter, val: CdrBasicTypes): CdrWriter {.discardable.} =
  this.align(sizeof(typeof(val)))
  this.ss.writeBe(val)
...
proc writeArray*(
    this: CdrWriter,
    value: openArray[CdrBasicTypes|string],
